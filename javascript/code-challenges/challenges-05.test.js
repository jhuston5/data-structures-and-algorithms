...
const toLastNames = people => {
  // Solution code here...
  let nameArr = (people.map((idx) => {
    return idx.firstName + ' ' + idx.lastName;
  }));
  return nameArr;
};
...
const addValues = (arr) => {
  // Solution code here...
  let sumValues = arr.reduce((acc, num) => {
    return acc + num;
  }, 0);
  return sumValues;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let sumPurchases = arr.reduce((acc, num) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let sumArrayObjects = arr.reduce((acc, num, idx) => {
    return idx + 1;
  }, 0);
...
const returnNames = (arr) => {
  ...
  let starWarsNameArr = arr.reduce((acc, starName) => {
    acc.push(starName.name);
    return acc;
  }, []);
  return starWarsNameArr;
};
