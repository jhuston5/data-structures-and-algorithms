...
const maxInArray = (arr) => {
  ...
  let maxNum = arr.reduce( function(current, value) {
...
const checkValues = (obj, value) => {
  ...
  // if (valuesArr !== value) {
  //   return false;
  // } else if (valuesArr === value) {
  //   return true;
  // }
  // let valueVar = true;
  // valuesArr === value ? valueVar = true : valueVar = false;
  // return valueVar;
...
const updateNumbers = (obj) => {
  // Solution code here...
  // let namesArr = Object.entries(obj).forEach(entry => {console.log(entry);});
...
const getHouses = (arr) => {
  ...
  //   // console.log(property, Object.values(arr.property));
  //   for (let houseName in Object.values(arr[property])) {
  //     console.log(Object.values(houseName));

  //     // houses.push(Object.values.arr.property.house);
  //   }
  // }
  // console.log(houses);
  // return houses;
  ...
  // for (let property in arr){
  //   console.log(Object.values(arr[property]));
  //   return Object.values(arr[property]);
  // }

  arr.forEach(charHouse => {
    Object.keys(charHouse).forEach((key, idx) => {
      if (key === 'house') houses.push(Object.values(charHouse)[idx]);
    });
  });
  return houses;
};
