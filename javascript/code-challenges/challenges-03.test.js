...
const containsAnd = (arr) => {
  // Solution code here...
  let filteredString = arr.filter((words) => {
    return words.includes('and');
  });
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let diffArray = arr.filter(function(item) {
